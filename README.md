...
* **Grid Factory**：网格化制造场景，强调 AGV 路径规划
* **Packet Factory**：事件/数据包驱动的通用工厂模型
...
### 1. 算法即组件（Algorithm as Component）
