...
from sky_executor.grid_factory.grid_factory.Agent.GridAgent import GridAgent
from sky_executor.grid_factory.grid_factory.Agent.RandomAgent import RandomAgent
from sky_executor.grid_factory.grid_factory.Agent.GreedyAgent import GreedyAgent
from sky_executor.grid_factory.grid_factory.Agent.PathPlanningAgent import PathPlanningAgent
from sky_logs.logger import LOGGER


@register_component("grid_factory.AgentFactory")
class AgentFactory:
    """
    智能体工厂类
